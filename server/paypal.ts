...
if (!PAYPAL_CLIENT_ID) {
  console.warn("Warning: PAYPAL_CLIENT_ID is not set - PayPal integration disabled");
}
if (!PAYPAL_CLIENT_SECRET) {
  console.warn("Warning: PAYPAL_CLIENT_SECRET is not set - PayPal integration disabled");
}
