...
- الحق في العلم: يحق لك معرفة طرق جمعنا لبياناتك الشخصية والمسوغ النظامي لجمعها ومعالجتها.
...
- الحق في تصحيح بياناتك الشخصية: يحق لك أن تطلب منا تصحيح بياناتك الشخصية، وستتم مراجعتها وتحديثها خلال ${data.response_days} أيام عمل.
...
لن تكون مطالباً بدفع أي رسوم مقابل ممارسة هذه الحقوق، وسيتم الرد عليك خلال ${data.response_days} أيام عمل من تاريخ استلام الطلب.
${dpoSection}
كيف تقدم شكوى أو اعتراضاً؟

في حال وجود بعض المخاوف، يمكنك تقديم شكوى إلى ${data.complaint_contact || 'إدارة خدمة العملاء'} باستخدام بيانات التواصل الموضحة أعلاه.
إذا لم تكن راضياً عن معالجتنا للشكوى أو في حال عدم ردنا خلال ${data.complaint_response_days} أيام عمل، يمكنك تقديم شكوى إلى الهيئة السعودية للبيانات والذكاء الاصطناعي (سدايا).
